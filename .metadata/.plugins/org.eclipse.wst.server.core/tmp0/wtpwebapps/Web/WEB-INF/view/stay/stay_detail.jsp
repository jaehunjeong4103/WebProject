  ...
  <div id="detail_body">
		...
		<div id ="reservation">		
	  	<div id="date_count">
	  		<div id="start_day">
	  			<span>입실일 : </span>
	  			<input type="text" name="start_day" class="choose_day" placeholder="입실일을 선택해주세요" onclick="view_start_cal()">	 
	  		</div>
	  		
	  		<div id="end_day" name="end_day">
	  			<span>퇴실일 : </span>
	  			<input type="text" name="end_day" class="choose_day" placeholder="퇴실일을 선택해주세요" onclick="view_end_cal()">
	  		</div>
				...
				<div id="room_list">
			        ...
			        <c:otherwise>
			        	<form action="/view/reservation/reservation" method="get">
			        		<input type="hidden" value="${stay.name}" name="stay_name">
			        		<input type="hidden" value="${r.name}" name="room_name">
			        		<input type="hidden" value="예약날짜" name="res_date">
