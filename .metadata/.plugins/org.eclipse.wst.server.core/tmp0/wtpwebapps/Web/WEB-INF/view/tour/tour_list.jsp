      ...
      <div id="list_head">
        ...
        <section id="bodyRight">
          ...
          <input type="submit" class="button" style="width: 50px; height: 28px; font-size: 18px; line-height: 28px;" value="검색">
			...
			<div id="list_item">
				<c:forEach var="t" items="${tour_list}">
					<a href="tour_detail?id=${t.id}">
						<div class="list">
							<div id="img" style="background-image: url('${t.image_path}' ); background-size: cover; background-position: center;"></div>
							<div id="text">
								<p>${t.name}</p>
								<p>주소 : ${t.address}</p>
								<p>전화번호 : ${t.phone}</p>
